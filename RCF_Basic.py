    ...
    for layer in range(layers):
        ...
        if plot: # Final array position in slice is dropped so -1 off end.
            ...
            if corners_setup is not None:
                ax[0].scatter(corners_setup[0,layer], corners_setup[1,layer], marker="x", color="white", s=200) # UL
                ax[0].scatter(corners_setup[2,layer], corners_setup[3,layer], marker="x", color="white", s=200) # UL
                ax[0].scatter(corners_setup[4,layer], corners_setup[5,layer], marker="x", color="white", s=200) # UL
